...
public class Compiler {
	...
	public Template compile() {
		...
		classVisitor = new TraceClassVisitor(classWriter, pw);
		writeHeader();
	...
	private void writeHeader() {
		String superClassName = "com/floreysoft/jmte/AbstractCompiledTemplate";
		String className = "com/floreysoft/jmte/compiledTemplates/Test";
